...
const Uploader& uploader, VkDeviceSize capacity) : allocator_(allocator), uploader_(uploader), capacity_(capacity)
{
...
GeometryRegistry::~GeometryRegistry() { allocator_.destroy_buffer(allocation_); }
